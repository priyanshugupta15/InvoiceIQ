...
export const TESTIMONIALS = [
  {
    quote:
      "InvoiceIQ has completely changed the way I create invoices! I just paste my project details and it instantly generates a clean, professional invoice — and it's 100% free!",
    author: "Simrat Singh",
  ...
  {
    quote:
      "This is hands down the best free invoicing tool I've ever used. It's simple, accurate, and saves me so much time every month. InvoiceIQ feels like having a smart assistant!",
  ...
  {
    quote:
      "I love how user-friendly InvoiceIQ is. I just enter my work hours and rates, and the AI does all the math — tax, total, everything. It's unbelievable that it's free!",
    author: "Simran Gill",
  ...
  {
    quote:
      "I used to pay for invoice apps, but InvoiceIQ gives me everything I need without any cost. The design is beautiful, and it works flawlessly every time!",
    author: "Arjun Mehta",
...
export const FAQS = [
  ...
  {
    question: "Is InvoiceIQ free to use?",
    answer: "Yes! InvoiceIQ is 100% free — no subscriptions, no trials, and no hidden fees. You can create unlimited invoices without paying a single rupee or dollar."
  },
  {
    question: "How does billing work if everything is free?",
    answer: "There’s no billing system! InvoiceIQ is built as a free, community-driven project to help freelancers, startups, and small businesses generate invoices easily."
  },
  {
  ...
  {
    question: "Who built InvoiceIQ?",
    answer: "InvoiceIQ was created by Harsimarpreet Singh Sahota as a passion project to simplify invoice management . It was developed to help freelancers, startups, and small businesses generate invoices effortlessly — all for free."
  },
  {
