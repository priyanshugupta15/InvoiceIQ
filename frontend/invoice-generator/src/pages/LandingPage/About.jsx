  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-16">
      <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
        <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">About InvoiceIQ</h1>
        <p className="text-slate-600 leading-relaxed mb-6">
          InvoiceIQ was built by <strong>Harsimarpreet Singh Sahota</strong> to make invoice management simple and smart using modern AI.
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-4 bg-gradient-to-tr from-blue-50 to-white rounded-lg border">
            <h4 className="font-semibold text-slate-900">Why InvoiceIQ?</h4>
