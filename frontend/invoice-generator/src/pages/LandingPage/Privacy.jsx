    ...
    <section className="max-w-4xl mx-auto px-6 py-16">
      <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <p className="text-slate-600 leading-relaxed mb-4">
          InvoiceIQ is a personal and educational project by Harsimarpreet Singh Sahota. It is designed to demonstrate full-stack development and AI integration skills.
        </p>
